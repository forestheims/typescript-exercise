/**
 * This is the answer to the annotate-me.ts exercise.
...
(async () => {
  ...
  do {
    ...
    // If we specifically test for sanitized-number, finalNumber is narrowed to
    // a SanitizedNumber, and finalNumber.value below is valid.
